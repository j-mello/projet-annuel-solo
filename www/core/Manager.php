...
use secretshop\connection\BDDInterface;
use secretshop\connection\PDOConnection;
use secretshop\models\Model;
...
class Manager
{
    ...
    public function save($objectToSave)
    {
        ...
        (
            array_map(function($k){return ':'.$k;}, array_keys($objectArray)), $objectArray
        );
